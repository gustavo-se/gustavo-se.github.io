...
const favActive = (e) => {
    if (e.target.classList.contains("fav-icon")) {
        ...
        let title = e.target.parentElement.parentElement.nextElementSibling.lastElementChild
            .textContent;
        let id = e.target.parentElement.parentElement.parentElement.previousElementSibling
            .dataset.id;
