...
const favActive = (e) => {
  if (e.target.classList.contains("fav-icon")) {
    ...
    let img = e.target.parentElement.parentElement.parentElement.previousElementSibling.getAttribute(
      "src"
    );
    let title =
      e.target.parentElement.parentElement.nextElementSibling.lastElementChild
        .textContent;
    let id =
